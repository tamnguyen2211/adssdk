...
public class RenderingIMA {
    ...
    public static String getHtmlWithVastContent(int width, int height, String vastContent, int skipOffset, int currentTime, Context context) {
        ...
        return htmlCode.toString().replace("[skip-duaration]", String.valueOf(skipOffset))
                .replace("[current-time]", String.valueOf(currentTime))
                .replace("[response]", vastContent);
//        return "<!DOCTYPE html>" +
//                "<html>" +
//                "<head>" +
//                "<title>Fpt Ads</title>" +
...
//                "var divAds = findFirstDescendant('adContainer', 'div');" +
//                "divAds.style.width = '100%';" +
//                "divAds.style.height = '100%';"+
